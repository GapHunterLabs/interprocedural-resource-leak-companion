package dev.gaphunter.interproceduralresourceleakcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.interproceduralresourceleakcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.interproceduralresourceleakcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Interprocedural Resource Leak Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34076-interprocedural-resource-leak-companion/reviews"
